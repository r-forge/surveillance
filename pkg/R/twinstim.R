...
# finetune: logocal indicating if a second maximisation should be performed with robust Nelder-Mead optim using as starting point the resulting parameters from the first maximisation. Default to TRUE.
