...
%\VignetteDepends{surveillance, lattice, spdep, gsl, colorspace, animation, gridExtra, scales, rmapshaper, fanplot, hhh4contacts}
...
knitr::write_bib(
    c("MASS", "Matrix", "spdep", "colorspace", "scales", "gridExtra", "lattice", "sp", "animation", "rmapshaper", "fanplot", "hhh4contacts"),
