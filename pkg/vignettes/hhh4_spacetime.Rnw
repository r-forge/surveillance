...
%\VignetteDepends{surveillance, lattice, spdep, gsl, colorspace, ggplot2, animation, gridExtra, scales, fanplot, hhh4contacts}
...
knitr::write_bib(
    c("MASS", "Matrix", "spdep", "colorspace", "scales", "gridExtra", "lattice", "sp", "ggplot2", "animation", "fanplot", "hhh4contacts"),
