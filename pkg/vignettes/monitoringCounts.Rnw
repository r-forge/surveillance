...
\label{sec:0}
\textbf{The content of this vignette corresponds to the article "Monitoring Count Time Series in \proglang{R}: Aberration Detection in Public Health Surveillance", Journal of Statistical Software, 2016", 70(10), 1-35, doi = \url{10.18637/jss.v070.i10}}.
...
plotOpts2$par.list <- list(mar=c(6,5,5,0),family="Times")
do.call("plot",plotOpts2)
...
plotOpts3$par.list <- list(mar=c(6,5,5,5),family="Times")
