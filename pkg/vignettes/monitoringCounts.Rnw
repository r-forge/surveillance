...
## MGLM 0.0.9 defines its own standardGeneric("AIC"), which masks stats::AIC ...
## This strangely carries over to other vignettes during R CMD build, where,
## e.g., the default AIC method is not found. We thus need to detach MGLM here.
unloadNamespace("MGLM")
@
