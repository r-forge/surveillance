...
See the
[reference section on outbreak detection](../../reference/index.html#prospective-outbreak-detection)
...
: fits data of class [`"epidataCS"`](../../reference/epidataCS.html), which
...
: fits data of class [`"epidata"`](../../reference/epidata.html)
...
: fits data of class [`"sts"`](../../reference/sts-class.html)
