...
and a weight matrix. The `"sts"` class supersedes the
[`"disProg"`](../../reference/create.disProg.html) class.

For evaluation purposes, the package contains several
[datasets](../../reference/index.html#section-datasets) drawn from the
...
[H&ouml;hle (2007)](https://doi.org/10.1007/s00180-007-0074-8) and
[`vignette("surveillance", package = "surveillance")`](https://CRAN.R-project.org/package=surveillance/vignettes/surveillance.pdf).
...
See the
[reference section on outbreak detection](../../reference/index.html#section-prospective-outbreak-detection)
...
: described in [`vignette("twinstim", package = "surveillance")`](https://CRAN.R-project.org/package=surveillance/vignettes/twinstim.pdf)
: associated data class: [`"epidataCS"`](../../reference/epidataCS.html)
...
`twinSIR()`
: to analyze the susceptible-infectious-recovered
...
: associated data class: [`"epidata"`](../../reference/epidata.html)
...
: described in
  ...
  [`vignette("hhh4", package = "surveillance")`](https://CRAN.R-project.org/package=surveillance/vignettes/hhh4.pdf),
  including the univariate case
: associated data class: [`"sts"`](../../reference/sts-class.html)


##### Applications

These endemic-epidemic modelling frameworks have proven useful in a wide range
of applications. We loosely maintain a list of publications:
<details>
  <summary>
  (click to expand)
  </summary>
...
knitr::kable(subset(refs_EE, select = -Species))
```
</details>
