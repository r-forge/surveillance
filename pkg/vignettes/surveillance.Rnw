...
######################################################################
compute <- !file.exists("surveillance-cache.RData")
#compute <- TRUE
#load computed results
if(!compute) load("surveillance-cache.RData")
...
save(list=c("sts.cdc","sts.farrington","acall","res","res.survstat","control","ten.surv",ls(pattern="measles")),
     file="surveillance-cache.RData")
@
