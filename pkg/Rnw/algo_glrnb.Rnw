...
%
  ...
  Discussion Paper 500 (the paper covers only the Poisson case). A moving-window generalized likelihood ratio
...
#Run 
cntrl = list(range=t,c.ARL=5, Mtilde=1, mu0=mu0, alpha=0.2, change="intercept",ret="value",dir="inc")
