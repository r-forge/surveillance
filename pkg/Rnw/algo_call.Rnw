...
\usage{
  \method{xtable}{algoQV}(x,caption = NULL, label = NULL, align = NULL, digits = NULL, display = NULL, ...)
}
\keyword{}
...
\arguments{
        ...
        \item{control}{specifies which surveillance systems should be used with their parameters.
                The parameter \code{funcName} and \code{range} must be specified where funcName must be
                the apropriate method function (without 'algo.'). \code{range} defines
