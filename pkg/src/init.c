...
// R-4.0.3> tools::package_native_routine_registration_skeleton("..")
...
/* .Call calls */
extern SEXP determineSourcesC(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"determineSourcesC", (DL_FUNC) &determineSourcesC, 6},
    {"eq3a",              (DL_FUNC) &eq3a,              3},
    {NULL, NULL, 0}
};
