...
# read in observed number of cases
flu.counts <- as.matrix(read.table(system.file("data/counts_flu_ByBw.txt", package = "surveillance")))
...
p <- matrix(read.table(system.file("data/population_2001-12-31_ByBw.txt",
...
if(compute){   
  ...
  save(result.B2, pred.B2, file="hhh4results.RData")
}
@
