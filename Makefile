...
check-allExamples: build-noVignettes
	_R_SURVEILLANCE_ALL_EXAMPLES_=TRUE R_CHECK_ENVIRON="" $R CMD check --ignore-vignettes --timings --run-dontrun --extra-arch --output=/tmp surveillance_${VERSION}.tar.gz
