...
extern "C" {
  ...
  //Atm, not clear what these lines are doing...
  //probably just advancing the iterator it to the point
  //where the alarm is generated. Can probably be removed
  unsigned int cont = 0;
